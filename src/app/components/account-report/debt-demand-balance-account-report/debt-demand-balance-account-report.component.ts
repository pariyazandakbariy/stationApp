...
@Component({
  selector: 'debt-demand-balance-account-report',
  templateUrl: './debt-demand-balance-account-report.component.html',
  styleUrls: ['./debt-demand-balance-account-report.component.scss'],
})
export class DebtDemandBalanceAccountReportComponent implements IModal {
